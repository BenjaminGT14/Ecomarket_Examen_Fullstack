...
public class ClienteServiceTest {
    ...
    void testFindAll() {
        ...
        cliente1.setId(1);
        cliente1.setNombre_apellido("Juan Perez");

        Cliente cliente2 = new Cliente();
        cliente2.setId(2);
        cliente2.setNombre_apellido("Maria Gomez");
    ...
    void testSave() {
        Cliente cliente = new Cliente();
        cliente.setNombre_apellido("Lucia Fernandez");
        ...
        assertEquals("Lucia Fernandez", resultado.getNombre_apellido());
    ...
    void testUpdate() {
        ...
        clienteExistente.setNombre_apellido("Ana Lopez");
